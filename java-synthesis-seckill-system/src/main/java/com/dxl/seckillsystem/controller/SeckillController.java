...
public class SeckillController {
     ...
     * @return
     */
    @RequestMapping(value = "/{seckillId}/{md5}/{killPhone}/execution", method = RequestMethod.POST, produces = {"application/json;charset=UTF-8"})
    @ResponseBody
    public SeckillResult<SeckillExecution> execute(@PathVariable("seckillId") Long seckillId,
                                                   @PathVariable("md5") String md5,
                                                   @PathVariable(value = "killPhone", required = false) Long phone) {
        if (phone == null) {
